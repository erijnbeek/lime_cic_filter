...
Disclaimer, this section is generated by AI based on the code comments, and manually checked.
...
- **0x6-0x7, 0xB-0xF**: Reserved for future CIC1 debug options
...
- **0xA-0xF**: Reserved for future CIC2 debug options
